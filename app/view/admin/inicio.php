    ...
    <div class="main-content">
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div style="height: 50px; background:white; margin-left: -45px" class="overview-wrap">
                            <h2 style="margin-left: 50px; color:#334a5f; font-weight: 900;" class="title-5"><a href="<?= _SERVER_;?>Ventas/envio_resumenes_diario" target="_blank">Tienes <?= count($boletas_pendientes);?> Boletas Pendientes de Envio</a> ENVIAR DIAS ESTABLECIDOS</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div style="height: 50px; background:white; margin-left: -45px" class="overview-wrap">
                            <h2 style="margin-left: 50px; color:#334a5f; font-weight: 900;" class="title-5"><a href="<?= _SERVER_;?>Ventas/historial_ventas" target="_blank">Tienes <?= count($facturas_pendientes);?> Facturas Pendientes de Envio</a> (Enviar al final del dia)</h2>
                        </div>
                    </div>
                </div>
                <br>
