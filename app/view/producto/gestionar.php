                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="producto_orden" name="producto_orden">
                            </div>
                        </div>
                        <div class="col-lg-2">
                                            ...
                                            foreach ($familia as $m){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-lg-10">
                                                                <input id="valor_nombre<?= $num?>" type="text" class="form-control" readonly value="<?= $m->producto_familia_nombre;?>">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-lg-10">
                                                                <input id="producto_orden<?= $num?>" type="text" class="form-control" readonly value="<?= $m->producto_orden;?>">
                                                            </div>
                                                        </div>
                                                    <td>
                                                        <a id="boton1<?= $num?>" style="color: green" type="button" onclick="quitar_read(<?= $num?>)"><i class="fa fa-edit"></i></a>
                                                        <a id="boton2<?= $num?>" style="color: blue" class="d-none" type="button" onclick="preguntar('¿Esta seguro de guardar el cambio?','guardar_cambios','SI','NO',<?=$m->id_producto_familia?>,<?= $num?>)" ><i class="fa fa-check"></i></a>
                            ...
                            <br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3" style="margin-top: 11px">
                                        <br><a class="btn btn-success" style="color: white;" onclick="agregar_precios()"><i class="fa fa-save"></i> Agregar</a>
                                    </div>
                                </div>
...
<script>
    ...
    function quitar_read(num){
        let valor = $("#valor_nombre"+num).attr("readonly",false);
        let orden = $("#producto_orden"+num).attr("readonly",false);

            $("#boton1"+num).addClass('d-none');
            $("#boton2"+num).removeClass('d-none');

    }

    function guardar_cambios(id,num){
        var valor = true;
        var valor_nombre = $('#valor_nombre'+num).val();
        var producto_orden = $('#producto_orden'+num).val();
        if(valor) {
            var cadena = "id_producto_familia=" + id +
                "&producto_orden=" + producto_orden+
                "&valor_nombre=" + valor_nombre;
            $.ajax({
                type: "POST",
                url: urlweb + "api/Producto/editar_familias",
                data: cadena,
                dataType: 'json',
                success: function (r) {
                    switch (r.result.code) {
                        case 1:
                            ...
                            break;
                        case 2:
                            respuesta('Error al editar, comuniquese con BufeoTec', 'error');
                            break;
                        default:
